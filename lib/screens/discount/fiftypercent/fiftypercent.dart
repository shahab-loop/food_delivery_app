...
class FiftyPercent extends StatelessWidget {
  const FiftyPercent({super.key});
              ...
              child: Container(
                ...
                child: SingleChildScrollView(
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        DiscountedButtonsWidget(first: 'Up To', second: ' 50%'),
                        Gap(10),
                        RedDiscountButtonWidget(image: 'assets/images/maindishes.png',onTap: () { Get.to(
                              () => JollofRice(),
                          arguments: {
                        ...
                        Gap(40),
                        RedDiscountButtonWidget(image: 'assets/images/Jollofspaghetti.png',onTap: () {
                          Get.to(
                                () => JollofRice(),
                            arguments: {
